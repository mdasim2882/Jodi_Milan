package com.jodimilans.matrimonial.ViewPagerAdapter.FragmentsStartUp;
...
public class OffersShow extends Fragment {
 ...
 static OffersShow instance;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_offers_show, container, false);
        TextView t=view.findViewById(R.id.offers_show_text);
        String bg="How JodiMilan works? Search for matches from over 10 lakhs of profiles";
        t.setText(bg);
