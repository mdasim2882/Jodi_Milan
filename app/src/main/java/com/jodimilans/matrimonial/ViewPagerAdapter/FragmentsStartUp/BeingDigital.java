...
public class BeingDigital extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_being_digital, container, false);
        TextView t=view.findViewById(R.id.being_digital_txt);
        String bg="How JodiMilan works? Create profile and start receiving intrests";
        t.setText(bg);
