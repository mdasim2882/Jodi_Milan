...
public class FormDataVariables {
    ...
    public static final String bEmployedIn="EmployedIn";
    ...
    public static final String bMaritalStatus="MaritalStatus";
    public static final String bHaveChildren="HaveChildren";
    public static final String bMotherTongue="MotherTongue";
